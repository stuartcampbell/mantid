...
void XYLimitsDialog::setXDim(const Mantid::Geometry::IMDDimension_const_sptr& dim) {
 ...
 * @param dim : IMDDimension */
void XYLimitsDialog::setYDim(const Mantid::Geometry::IMDDimension_const_sptr& dim) {
