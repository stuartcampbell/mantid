...
curveDataFromWs(const Mantid::API::MatrixWorkspace_const_sptr& ws, size_t wsIndex);
...
curveErrorsFromWs(const Mantid::API::MatrixWorkspace_const_sptr& ws, size_t wsIndex);
