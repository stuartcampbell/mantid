 ...
 */
boost::optional<size_t>
IndirectFitPropertyBrowserLegacy::functionIndex(const IFunction_sptr& function) const {
 ...
 */
void IndirectFitPropertyBrowserLegacy::setParameterValue(
    const IFunction_sptr& function, const std::string &parameterName, double value) {
