...
void ALCBaselineModellingModel::enableDisabledPoints(
    const MatrixWorkspace_sptr& destWs, const MatrixWorkspace_const_sptr& sourceWs) {
 ...
 */
void ALCBaselineModellingModel::setErrorsAfterFit(const MatrixWorkspace_sptr& data) {
