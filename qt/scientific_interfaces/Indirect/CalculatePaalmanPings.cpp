 ...
 */
void CalculatePaalmanPings::addShapeSpecificSampleOptions(const IAlgorithm_sptr& alg,
                                                          const QString& shape) {
  if (shape == "FlatPlate") {
 ...
 * @param shape Sample shape
 */
void CalculatePaalmanPings::addShapeSpecificCanOptions(const IAlgorithm_sptr& alg,
                                                       const QString& shape) {
  if (shape == "FlatPlate") {
