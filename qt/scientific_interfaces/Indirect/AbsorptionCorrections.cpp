 ...
 */
void AbsorptionCorrections::addShapeSpecificSampleOptions(const IAlgorithm_sptr& alg,
                                                          const QString& shape) {
 ...
 * @param shape Sample shape
 */
void AbsorptionCorrections::addShapeSpecificCanOptions(const IAlgorithm_sptr& alg,
                                                       QString const &shape) {
  if (shape == "FlatPlate") {
...
void AbsorptionCorrections::convertSpectrumAxes(
    const WorkspaceGroup_sptr& correctionsGroup, const MatrixWorkspace_sptr& sample) {
