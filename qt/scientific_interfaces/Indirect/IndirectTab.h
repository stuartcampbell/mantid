...
protected:
  ...
  /// pointer
  bool getResolutionRangeFromWs(const Mantid::API::MatrixWorkspace_const_sptr& ws,
                                QPair<double, double> &res);
  ...
  QPair<double, double>
  getXRangeFromWorkspace(const Mantid::API::MatrixWorkspace_const_sptr& workspace,
                         double precision = 0.000001) const;
