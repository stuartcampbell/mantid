...
boost::optional<std::string> findFullParameterName(const IFunction_sptr& function,
...
IqtFitModel::createFunctionWithGlobalBeta(const IFunction_sptr& function) const {
