...
private:
  ...
  void plotParameter(const Mantid::API::WorkspaceGroup_const_sptr& groupWorkspace,
                     std::string const &parameter);
  void plotParameter(const Mantid::API::MatrixWorkspace_const_sptr& workspace,
                     std::string const &parameter);
  void plotParameterSpectrum(const Mantid::API::MatrixWorkspace_const_sptr& workspace,
                             std::string const &parameter);
