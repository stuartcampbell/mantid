...
void Elwin::setDefaultResolution(const Mantid::API::MatrixWorkspace_const_sptr& ws,
...
void Elwin::setDefaultSampleLog(const Mantid::API::MatrixWorkspace_const_sptr& ws) {
  auto inst = ws->getInstrument();
