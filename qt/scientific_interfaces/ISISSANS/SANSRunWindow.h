...
private:
  ...
  getGroupMember(const Mantid::API::Workspace_const_sptr& in, const int member) const;
...
private:
  ...
  void setupQResolutionRectangularAperture(const QString& h1, const QString& w1, const QString& h2,
                                           const QString& w2);
  ...
  void setQResolutionApertureType(QResoluationAperture apertureType,
                                  const QString& a1H1Label, const QString& a2H2Label,
                                  const QString& a1H1, const QString& a2H2,
                                  const QString& toolTipA1H1, const QString& toolTipA2H2,
                                  bool w1W2Disabled);
