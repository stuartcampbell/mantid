...
void setTransmissionOnSaveCommand(
    QString &saveCommand, const Mantid::API::MatrixWorkspace_sptr& matrix_workspace,
 ...
 */
void SANSRunWindow::setupQResolutionRectangularAperture(const QString& h1, const QString& w1,
                                                        const QString& h2,
                                                        const QString& w2) {
...
void SANSRunWindow::setQResolutionApertureType(
    QResoluationAperture apertureType, const QString& a1H1Label, const QString& a2H2Label,
    const QString& a1H1, const QString& a2H2, const QString& toolTipA1H1, const QString& toolTipA2H2,
    bool w1W2Disabled) {
  // Set the labels
...
SANSRunWindow::retrieveBackgroundCorrectionSetting(bool isTime, bool isMon) {
  ...
  auto createPythonScript = [](bool isTime, bool isMon, const QString& component) {
