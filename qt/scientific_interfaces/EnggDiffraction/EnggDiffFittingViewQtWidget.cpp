...
EnggDiffFittingViewQtWidget::EnggDiffFittingViewQtWidget(
    ...
    : IEnggDiffFittingView(), m_fittedDataVector(),
      m_fileSettings(std::move(fileSettings)), m_mainMsgProvider(std::move(mainMsg)),
      m_mainSettings(std::move(mainSettings)), m_mainPythonRunner(std::move(mainPythonRunner)),
