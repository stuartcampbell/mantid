...
struct originWindow {
  ...
  originWindow(std::string _name = "", std::string _label = "",
               bool _bHidden = false)
      : name(std::move(_name)), label(std::move(_label)), objectID(0), bHidden(_bHidden),
...
struct spreadColumn {
  ...
  spreadColumn(std::string _name = "", int _index = 0)
      : name(std::move(_name)), type(NONE), value_type(0), value_type_specification(0),
...
struct spreadSheet : public originWindow {
  ...
  spreadSheet(std::string _name = "")
      : originWindow(std::move(_name)), maxRows(0), bLoose(true), bMultisheet(false),
        column(){};
};
...
struct excel : public originWindow {
  ...
  excel(std::string _name = "", std::string _label = "", int _maxRows = 0,
      ...
      : originWindow(std::move(_name), std::move(_label), _bHidden), maxRows(_maxRows),
        bLoose(_bLoose){};
};
...
struct function {
  ...
  function(std::string _name = "", int _index = 0)
      : name(std::move(_name)), type(0), formula(""), begin(0.0), end(0.0), points(0),
        index(_index){};
};
