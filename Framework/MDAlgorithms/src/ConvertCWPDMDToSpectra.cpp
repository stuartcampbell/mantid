...
void ConvertCWPDMDToSpectra::findXBoundary(
    const API::IMDEventWorkspace_const_sptr& dataws, const std::string &targetunit,
 ...
 */
void ConvertCWPDMDToSpectra::binMD(const API::IMDEventWorkspace_const_sptr& mdws,
                                   const char &unitbit,
