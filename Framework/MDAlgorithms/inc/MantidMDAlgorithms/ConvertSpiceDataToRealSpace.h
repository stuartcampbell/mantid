...
private:
  ...
  loadRunToMatrixWS(const DataObjects::TableWorkspace_sptr& tablews, size_t irow,
                    const API::MatrixWorkspace_const_sptr& parentws,
  ...
  parseDetectorEfficiencyTable(const DataObjects::TableWorkspace_sptr& detefftablews);
