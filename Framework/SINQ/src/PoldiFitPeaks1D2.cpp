...
void PoldiFitPeaks1D2::setValuesFromProfileFunction(
    const PoldiPeak_sptr& poldiPeak, const IFunction_sptr &fittedFunction) const {
...
double
PoldiFitPeaks1D2::getFwhmWidthRelation(const IPeakFunction_sptr& peakFunction) const {
