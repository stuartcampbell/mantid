...
doTest(const std::string& algoName, const std::string& lhs, const std::string& rhs,
       const std::string& outName, bool succeeds = true, const std::string& otherProp = "",
...
DLLExport Mantid::DataObjects::MDHistoWorkspace_sptr
doTest(const std::string& algoName, const std::string& inName, const std::string& outName,
