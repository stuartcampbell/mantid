...
MDHistoWorkspace_sptr doTest(const std::string& algoName, const std::string& lhs,
                             const std::string& rhs, const std::string& outName,
                             bool succeeds, const std::string& otherProp,
...
MDHistoWorkspace_sptr doTest(const std::string& algoName, const std::string& inName,
