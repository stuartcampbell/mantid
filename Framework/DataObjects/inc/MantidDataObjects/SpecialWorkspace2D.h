...
private:
  ...
  bool isCompatible(std::shared_ptr<const SpecialWorkspace2D> ws);
...
protected:
  ...
  void binaryAND(std::shared_ptr<const SpecialWorkspace2D> ws);
  void binaryOR(std::shared_ptr<const SpecialWorkspace2D> ws);
  void binaryXOR(std::shared_ptr<const SpecialWorkspace2D> ws);
  void binaryNOT();
