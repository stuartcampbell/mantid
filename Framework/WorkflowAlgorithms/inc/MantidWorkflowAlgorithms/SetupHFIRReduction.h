...
private:
  ...
  void
  setupBackground(const boost::shared_ptr<Kernel::PropertyManager>& reductionManager);
  void
  setupSensitivity(const boost::shared_ptr<Kernel::PropertyManager>& reductionManager);
};
