...
private:
  ...
  void sumUnmaskedDetectors(const API::MatrixWorkspace_sptr& rebinnedWS, double &sum,
  ...
  void maskEdges(const API::MatrixWorkspace_sptr& ws, int high, int low, int left,
