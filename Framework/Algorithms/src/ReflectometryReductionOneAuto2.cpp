...
ReflectometryReductionOneAuto2::getDetectorNames(const MatrixWorkspace_sptr& inputWS) {
 ...
 */
double
ReflectometryReductionOneAuto2::calculateTheta(const MatrixWorkspace_sptr& inputWS) {
...
ReflectometryReductionOneAuto2::rebinAndScale(const MatrixWorkspace_sptr& inputWS,
