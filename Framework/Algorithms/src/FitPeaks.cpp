...
bool FitPeaks::decideToEstimatePeakParams(
    const bool firstPeakInSpectrum, const API::IPeakFunction_sptr& peak_function) {
 ...
 */
double FitPeaks::fitIndividualPeak(size_t wi, const API::IAlgorithm_sptr& fitter,
 ...
 */
double FitPeaks::fitFunctionSD(const IAlgorithm_sptr& fit,
 ...
 */
void FitPeaks::reduceByBackground(const API::IBackgroundFunction_sptr& bkgd_func,
