 ...
 */
API::MatrixWorkspace_sptr
CalculateTransmission::fitData(const API::MatrixWorkspace_sptr& WS, double &grad,
                               double &offset) {
 ...
 */
API::MatrixWorkspace_sptr
CalculateTransmission::fitPolynomial(const API::MatrixWorkspace_sptr& WS, int order,
                                     std::vector<double> &coeficients) {
...
void CalculateTransmission::logIfNotMonitor(const API::MatrixWorkspace_sptr& sampleWS,
                                            const API::MatrixWorkspace_sptr& directWS,
                                            size_t index) {
