...
ReflectometryReductionOneAuto3::getDetectorNames(const MatrixWorkspace_sptr& inputWS) {
 ...
 */
double
ReflectometryReductionOneAuto3::calculateTheta(const MatrixWorkspace_sptr& inputWS) {
