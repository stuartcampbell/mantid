...
ReflectometryWorkflowBase2::convertToWavelength(const MatrixWorkspace_sptr& inputWS) {
...
MatrixWorkspace_sptr ReflectometryWorkflowBase2::cropWavelength(
    const MatrixWorkspace_sptr& inputWS, const bool useArgs, const double argMin,
    const double argMax) {
...
MatrixWorkspace_sptr ReflectometryWorkflowBase2::rebinDetectorsToMonitors(
    const MatrixWorkspace_sptr& detectorWS, const MatrixWorkspace_sptr& monitorWS) {
...
std::string ReflectometryWorkflowBase2::findProcessingInstructions(
    const Instrument_const_sptr& instrument, const MatrixWorkspace_sptr& inputWS) const {
 ...
 */
double
ReflectometryWorkflowBase2::getThetaFromLogs(const MatrixWorkspace_sptr& inputWs,
...
void ReflectometryWorkflowBase2::convertProcessingInstructions(
    Instrument_const_sptr instrument, const MatrixWorkspace_sptr& inputWS) {
