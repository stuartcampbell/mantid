...
double GetEi2::calculateFirstMoment(API::MatrixWorkspace_sptr monitor_ws,
  ...
  calculatePeakWidthAtHalfHeight(std::move(monitor_ws), prominence, peak_x, peak_y,
                                 peak_e);
...
*/
API::MatrixWorkspace_sptr GetEi2::rebin(const API::MatrixWorkspace_sptr& monitor_ws,
