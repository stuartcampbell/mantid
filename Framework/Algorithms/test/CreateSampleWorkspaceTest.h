...
public:
  ...
  MatrixWorkspace_sptr createSampleWorkspace(
      const std::string& outWSName, const std::string& wsType = "", const std::string& function = "",
      const std::string& userFunction = "", int numBanks = 2, int bankPixelWidth = 10,
      int numEvents = 1000, bool isRandom = false, const std::string& xUnit = "TOF",
