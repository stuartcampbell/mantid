...
void LoadRawHelper::runLoadInstrument(
    const std::string &fileName, const DataObjects::Workspace2D_sptr& localWorkspace,
 ...
 */
void LoadRawHelper::loadRunParameters(const API::MatrixWorkspace_sptr& localWorkspace,
...
void LoadRawHelper::loadSpectra(
    ...
    const DataObjects::Workspace2D_sptr& ws_sptr,
    const std::vector<boost::shared_ptr<HistogramData::HistogramX>>& timeChannelsVec) {
