 ...
 */
void FilterEventsByLogValuePreNexus::addToWorkspaceLog(const std::string& logtitle,
                                                       size_t mindex) {
...
void FilterEventsByLogValuePreNexus::runLoadInstrument(
    const std::string &eventfilename, const MatrixWorkspace_sptr& localWorkspace) {
