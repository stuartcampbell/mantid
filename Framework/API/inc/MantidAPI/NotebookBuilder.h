...
public:
  ...
  const std::string build(const std::string& ws_name, const std::string& ws_title,
...
private:
  ...
  const std::string
  buildPropertyString(const Mantid::Kernel::PropertyHistory_const_sptr& propHistory);
