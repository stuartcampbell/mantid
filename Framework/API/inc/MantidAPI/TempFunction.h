...
namespace Mantid {
namespace API {
/** This is a temporary helper class to aid transition from IFitFunction to
   IFunction.
...
public:
  ...
  /// CompositeFunction it returns
  /// a top-level function that contains the parameter. The return function
