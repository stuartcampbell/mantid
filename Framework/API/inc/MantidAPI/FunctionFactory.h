...
private:
  ...
  void addConstraints(std::shared_ptr<IFunction> fun,
                      const Expression &expr) const;
  /// Add a single constraint to the created function
  void addConstraint(std::shared_ptr<IFunction> fun,
                     const Expression &expr) const;
  ...
  void addTies(std::shared_ptr<IFunction> fun, const Expression &expr) const;
  /// Add a tie to the created function
  void addTie(std::shared_ptr<IFunction> fun, const Expression &expr) const;
