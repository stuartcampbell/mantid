...
private:
  ...
  void addTies(const boost::shared_ptr<IFunction>& fun, const Expression &expr) const;
  /// Add a tie to the created function
  void addTie(const boost::shared_ptr<IFunction>& fun, const Expression &expr) const;
