...
public:
  ...
  void
  setMuonProcessPeriodProperties(IAlgorithm &alg, const API::Workspace_sptr& inputWS,
  ...
  API::MatrixWorkspace_sptr
  createPairWorkspaceFromGroupWorkspaces(const API::MatrixWorkspace_sptr& inputWS1,
