...
LeBailFit::cropWorkspace(const API::MatrixWorkspace_sptr& inpws, size_t wsindex) {
 ...
 * vector
 */
void LeBailFit::parseBackgroundTableWorkspace(const TableWorkspace_sptr& bkgdparamws,
