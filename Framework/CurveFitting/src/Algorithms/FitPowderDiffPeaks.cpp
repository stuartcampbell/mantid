...
void FitPowderDiffPeaks::observePeakRange(const BackToBackExponential_sptr& thispeak,
                                          const BackToBackExponential_sptr& rightpeak,
                                          double refpeakshift,
...
bool FitPowderDiffPeaks::fitSinglePeakRobust(
    const BackToBackExponential_sptr& peak, const BackgroundFunction_sptr& backgroundfunction,
    double peakleftbound, double peakrightbound,
    const map<string, double>& rightpeakparammap, double &finalchi2) {
...
bool FitPowderDiffPeaks::doFit1PeakBackground(
    const Workspace2D_sptr& dataws, size_t wsindex, const BackToBackExponential_sptr& peak,
...
bool FitPowderDiffPeaks::doFit1PeakSequential(
    const Workspace2D_sptr& dataws, size_t workspaceindex,
    const BackToBackExponential_sptr& peakfunction, vector<string> minimzernames,
    vector<size_t> maxiterations, const vector<double>& dampfactors, double &chi2) {
  // 1. Check
 ...
 */
bool FitPowderDiffPeaks::doFitGaussianPeak(const DataObjects::Workspace2D_sptr& dataws,
...
bool FitPowderDiffPeaks::doFitMultiplePeaks(
    const Workspace2D_sptr& dataws, size_t wsindex, const CompositeFunction_sptr& peaksfunc,
...
bool FitPowderDiffPeaks::doFitNPeaksSimple(
    const Workspace2D_sptr& dataws, size_t wsindex, const CompositeFunction_sptr& peaksfunc,
    const vector<BackToBackExponential_sptr>& peakfuncs, const string& minimizername,
    size_t maxiteration, double &chi2) {
  // 1. Debug output
  stringstream dbss0;
...
/** Parse fit result
 */
std::string FitPowderDiffPeaks::parseFitResult(const API::IAlgorithm_sptr& fitalg,
 ...
 */
Workspace2D_sptr
FitPowderDiffPeaks::buildPartialWorkspace(const API::MatrixWorkspace_sptr& sourcews,
                                          size_t workspaceindex,
