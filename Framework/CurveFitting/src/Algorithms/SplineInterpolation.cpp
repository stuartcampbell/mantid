...
SplineInterpolation::setupOutputWorkspace(const API::MatrixWorkspace_sptr& mws,
...
SplineInterpolation::findInterpolationRange(const MatrixWorkspace_const_sptr& iwspt,
