 ...
 */
void LeBailFunction::setFitProfileParameter(const string& paramname, double minvalue,
                                            double maxvalue) {
 ...
 */
double
LeBailFunction::getPeakParameterValue(const API::IPowderDiffPeakFunction_sptr& peak,
