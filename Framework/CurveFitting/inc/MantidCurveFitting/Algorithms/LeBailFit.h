...
private:
  ...
  API::MatrixWorkspace_sptr cropWorkspace(const API::MatrixWorkspace_sptr& inpws,
                                          size_t wsindex);
  ...
  void
  parseBackgroundTableWorkspace(const DataObjects::TableWorkspace_sptr& bkgdparamws,
  ...
  void
  setupRandomWalkStrategyFromTable(const DataObjects::TableWorkspace_sptr& tablews);
