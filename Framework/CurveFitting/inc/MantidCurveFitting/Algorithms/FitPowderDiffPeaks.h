...
private:
  ...
  bool
  fitSinglePeakRobust(const Functions::BackToBackExponential_sptr& peak,
  ...
  bool
  fitSinglePeakSimulatedAnnealing(const Functions::BackToBackExponential_sptr& peak,
  ...
  bool
  fitSinglePeakConfident(const Functions::BackToBackExponential_sptr& peak,
                         const Functions::BackgroundFunction_sptr& backgroundfunction,
  ...
  bool doFit1PeakSimple(const DataObjects::Workspace2D_sptr& dataws,
                        size_t workspaceindex,
                        const Functions::BackToBackExponential_sptr& peakfunction,
                        const std::string& minimzername, size_t maxiteration,
                        double &chi2);
  ...
  bool
  doFit1PeakBackground(const DataObjects::Workspace2D_sptr& dataws, size_t wsindex,
                       const Functions::BackToBackExponential_sptr& peak,
                       const Functions::BackgroundFunction_sptr& backgroundfunction,
                       double &chi2);

  /// Fit 1 peak by using a sequential of minimizer
  bool doFit1PeakSequential(const DataObjects::Workspace2D_sptr& dataws,
                            size_t workspaceindex,
                            const Functions::BackToBackExponential_sptr& peakfunction,
...
bool observePeakParameters(const DataObjects::Workspace2D_sptr& dataws, size_t wsindex,
